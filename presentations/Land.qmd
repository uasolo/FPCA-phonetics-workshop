...
-   Does not align curves based on their shapes
    -   It is not DTW
-   Does not depend on the curves at all
    -   It acts on the time axis on the basis of the landmarks
:::
...
-   Curve shape distorted
-   Predicted curves do not show duration variation
-   [Landmakrs are preserved]{style="color:green"}
