...
Suppose we have curves belonging to two categories: P (Peak) and NP (No Peak):
...
Category.labels <- c("NP (No Peak)", "P (Peak)")
# plot a few curves
ggplot(curves %>% filter(curveId %in% sample(nCurves, 16))) +
...
We could could use some combination of linear regression and polynomial curve fitting:
