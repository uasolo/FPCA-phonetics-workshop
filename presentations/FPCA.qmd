...
-   Day 1, 2: uni-dimensional FPCA
-   Day 3: multi-dimensional FPCA
-   Day 4: landmark registration
-   Day 5: UTI? more exercises and examples
...
::: incremental
-   Functional PCA (from scratch)
-   Landmark Registration (from scratch)
-   Linear (Mixed Effects) Regression (assumed)
-   GAMMs (optional, for comparison)
:::

## Code

::: incremental
-   based on R, `tidyverse`
...
-   [f0](https://www.prosodylab.linguistics.northwestern.edu/files/2024/06/Cole_Steffman_Awwad_Speech-Prosody_2024.pdf) in @cole2024functional
-   [f0 and syllable duration](https://repository.ubn.ru.nl/bitstream/handle/2066/303654/303654pub.pdf) in @arvaniti2024variability
-   [f0, F1, F2, CPP, HNR, OQ](https://www.degruyterbrill.com/document/doi/10.1515/phon-2024-0047/html) in @maspong2025voice
